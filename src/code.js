...
function getAllDirectors(moviesArray) {
  const directors = moviesArray
    .map((currentMovie) => currentMovie.director)
  ...
  //     if (!newArr.includes(moviesArray[i].director))
  //       newArr.push(moviesArray[i].director);
  //   }
...
function orderByYear(moviesArray) {} // .sort .localeCompare

// Iteration 6: Alphabetic Order - Order by title and print the first 20 titles
function orderAlphabetically(moviesArray) {} // .localCompare e slice

// BONUS - Iteration 7: Time Format - Turn duration of the movies from hours to minutes
function turnHoursToMinutes(moviesArray) {} // regex
